---
title: "Exploratory data anlayis (EDA) of missing data"
subtitle: "CSP 2021"
author: "Emile Latour"
...
When working with missing data in R, there are lots of packages that can be really helpful. [mice](https://www.gerkovink.com/miceVignettes/Missingness_inspection/Missingness_inspection.html) has some great functions that Van Buuren highlights. The [`VIM`](https://cran.r-project.org/web/packages/VIM/index.html) package has some great tools as well. My preference is to use the [`naniar`](https://cran.r-project.org/web/packages/naniar/index.html) package for inspecting missingness.
...
How many missing values does each case have?
...
+ 41.4% of cases (rows) have at least one missing value.
